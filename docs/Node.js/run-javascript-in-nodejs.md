...
![Node.js의 구성요소](/img/components-of-nodejs.png)
...
![V8 엔진의 JS 코드 컴파일 단계](/img/v8-compile.png)
...
![libuv 아키텍처](/img/libuv-architecture.png)
...
![nodejs 아키텍처](/img/nodejs-architecture.png)
